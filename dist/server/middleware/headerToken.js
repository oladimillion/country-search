...
exports.default = (function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var accessToken, _a, refreshToken, ip, userAgent, decoded;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, session_1.default.get(accessToken)];
            case 1:
                _a = _b.sent(), refreshToken = _a.refreshToken, ip = _a.ip, userAgent = _a.userAgent;
                decoded = jwt_1.default.decode(accessToken);
                ...
                if (decoded.user) {
                    ...
                    // @ts-ignore
                    req.user = jwt_1.default.decode(refreshToken);
                    return [2 /*return*/, next()];
                }
                return [2 /*return*/, next()];
        }

...
var search = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var API_KEY, URL, country_name, PATH, data, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                API_KEY = process.env.COUNTRY_SEARCH_API_KEY;
                URL = process.env.COUNTRY_SEARCH_URI;
                country_name = req.query.country_name;
                PATH = URL + "/" + country_name + "?access_key=" + API_KEY + "&FullText=true";
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
            ...
            case 2:
                data = (_a.sent()).data;
                if ((0, lodash_1.get)(data, "error")) {
                    return [2 /*return*/, res
                            .status(400)
                            .json({ message: "Couldn't find '" + country_name + "' country" })];
                }
                else {

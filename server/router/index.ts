...
router.get("/api/v1/country/search", mustBeAuthenticated, validateRequest(countrySchema), countryCtrl.search)

router.use((req: Request, res: Response) => res.status(404).json({ message: "route does not exist" }))
